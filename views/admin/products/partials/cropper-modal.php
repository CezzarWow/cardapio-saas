<?php
/**
 * CROPPER-MODAL.PHP - Modal de Recorte de Imagem (duplicado para pasta específica)
 * Esse arquivo espelha `views/admin/partials/cropper-modal.php` para compatibilidade.
 */
?>
