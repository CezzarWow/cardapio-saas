...
class RestaurantRepository
{
    ...
    public function updateFull(int $id, array $data): void
    {
        ...
        if (isset($data['address_number'])) { $fields[] = "address_number = :address_number"; $params['address_number'] = $data['address_number']; }
        if (isset($data['zip_code'])) { $fields[] = "zip_code = :zip_code"; $params['zip_code'] = $data['zip_code']; }
        if (isset($data['primary_color'])) { $fields[] = "primary_color = :primary_color"; $params['primary_color'] = $data['primary_color']; }
        if (isset($data['logo'])) { $fields[] = "logo = :logo"; $params['logo'] = $data['logo']; }
