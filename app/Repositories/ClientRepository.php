...
class ClientRepository
{
    ...
    public function update(int $id, array $data): void
    {
        ...
        if (isset($data['address'])) { $sql .= ", address = :address"; $params['address'] = $data['address']; }
        if (isset($data['number'])) { $sql .= ", address_number = :number"; $params['number'] = $data['number']; }
        if (isset($data['neighborhood'])) { $sql .= ", neighborhood = :neighborhood"; $params['neighborhood'] = $data['neighborhood']; }
