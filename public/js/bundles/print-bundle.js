/* print-bundle - Generated 2026-01-27T18:27:38.385Z */

// Guard contra carregamento duplicado no SPA
if (window._printBundleLoaded) {
    console.log('[print-bundle] Já carregado, pulando re-execução');
} else {
    window._printBundleLoaded = true;
...
} // Fim do guard contra carregamento duplicado
