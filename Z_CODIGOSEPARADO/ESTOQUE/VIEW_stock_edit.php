<?php
// LOCALIZACAO ORIGINAL: views/admin/stock/edit.php 
            ...
            <form action="<?= BASE_URL ?>/admin/loja/produtos/atualizar" method="POST" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 15px;">
                ...
                <div style="display: flex; gap: 15px;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="price" required value="<?= number_format($product['price'], 2, ',', '.') ?>" style="width: 100%; padding: 10px; border: 1px solid #d1d5db; border-radius: 8px;">
                    </div>
                </div>

                <!-- [FASE 1] Campo de Estoque -->
                <div>
                    ...
                    <small style="color: #6b7280; font-size: 0.85rem;">Quantidade em estoque (pode ser negativo)</small>
                </div>
