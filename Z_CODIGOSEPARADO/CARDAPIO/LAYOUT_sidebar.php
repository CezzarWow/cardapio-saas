<!-- 
═══════════════════════════════════════════════════════════════════════════
LOCALIZAÇÃO ORIGINAL: views/admin/panel/layout/sidebar.php
═══════════════════════════════════════════════════════════════════════════

DESCRIÇÃO: Menu lateral usado em TODAS as páginas do painel
IMPORTANTE: Contém os links para todas as abas do sistema

COMO FUNCIONA:
- ViewHelper::isRouteActive() detecta a rota atual e destaca o menu
- Cada ítem é um link com ícone Lucide
- O link do Cardápio aponta para: /admin/loja/cardapio
═══════════════════════════════════════════════════════════════════════════
-->
